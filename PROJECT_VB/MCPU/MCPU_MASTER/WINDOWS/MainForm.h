...
namespace CppCLRWinFormsProject {
	...
	private: System::Windows::Forms::Label^ labelFW326;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelFW326 = (gcnew System::Windows::Forms::Label());
			...
			this->BoardInitialization->Controls->Add(this->label17);
			this->BoardInitialization->Controls->Add(this->labelPcb326Activity);
			this->BoardInitialization->Controls->Add(this->label1);
			this->BoardInitialization->Controls->Add(this->labelShActivity);
			...
			this->BoardInitialization->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold));
			...
			this->BoardInitialization->Location = System::Drawing::Point(26, 189);
			this->BoardInitialization->Name = L"BoardInitialization";
			this->BoardInitialization->Size = System::Drawing::Size(549, 231);
			...
			this->labelShActivity->Location = System::Drawing::Point(216, 165);
			...
			this->label2->Size = System::Drawing::Size(214, 31);
			...
			this->groupBoxPackage->Controls->Add(this->labelFW326);
			...
			this->groupBoxPackage->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold));
			...
			this->groupBoxPackage->Size = System::Drawing::Size(549, 118);
			...
			// labelFW326
			// 
			this->labelFW326->AutoSize = true;
			this->labelFW326->ForeColor = System::Drawing::Color::White;
			this->labelFW326->Location = System::Drawing::Point(300, 70);
			this->labelFW326->Name = L"labelFW326";
			this->labelFW326->Size = System::Drawing::Size(137, 16);
			this->labelFW326->TabIndex = 7;
			this->labelFW326->Text = L"FW 326 REVISION:";
			// 
			// labelCanDriver
			// 
			this->labelCanDriver->AutoSize = true;
			this->labelCanDriver->ForeColor = System::Drawing::Color::White;
			this->labelCanDriver->Location = System::Drawing::Point(20, 90);
			this->labelCanDriver->Name = L"labelCanDriver";
			this->labelCanDriver->Size = System::Drawing::Size(178, 16);
			...
			this->labelGeneratorRevision->Location = System::Drawing::Point(300, 90);
			this->labelGeneratorRevision->Name = L"labelGeneratorRevision";
			this->labelGeneratorRevision->Size = System::Drawing::Size(127, 16);
			this->labelGeneratorRevision->TabIndex = 5;
			this->labelGeneratorRevision->Text = L"SHFD REVISION:";
			// 
			// labelFW315
			// 
			this->labelFW315->AutoSize = true;
			this->labelFW315->ForeColor = System::Drawing::Color::White;
			this->labelFW315->Location = System::Drawing::Point(20, 70);
			this->labelFW315->Name = L"labelFW315";
			this->labelFW315->Size = System::Drawing::Size(137, 16);
			...
			this->labelFW304->Location = System::Drawing::Point(300, 50);
			this->labelFW304->Name = L"labelFW304";
			this->labelFW304->Size = System::Drawing::Size(137, 16);
			...
			this->labelFW303->Location = System::Drawing::Point(20, 50);
			this->labelFW303->Name = L"labelFW303";
			this->labelFW303->Size = System::Drawing::Size(137, 16);
			...
			this->labelFW302->Location = System::Drawing::Point(300, 30);
			this->labelFW302->Name = L"labelFW302";
			this->labelFW302->Size = System::Drawing::Size(137, 16);
			...
			this->labelFW301->Size = System::Drawing::Size(137, 16);
			...
			this->StartupErrorMessages->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F));
			...
			this->StartupLogMessages->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F));
			...
			this->labelGeneratorActivity->Location = System::Drawing::Point(216, 185);
			...
			this->label17->Location = System::Drawing::Point(10, 185);
