...
System::Byte PCB302::getPaddleCollimationFormat(paddleCodes paddle_code) {
	...
	try {
		...
		case paddleCodes::PADDLE_PROSTHESIS: return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_PROSTHESIS)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_BIOP2D:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_BIOP2D)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_BIOP3D:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_BIOP3D)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_TOMO:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_TOMO)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_24x30_CONTACT:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_24x30_CONTACT)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_18x24_C_CONTACT:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_18x24_C_CONTACT)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_18x24_L_CONTACT:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_18x24_L_CONTACT)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_18x24_R_CONTACT:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_18x24_R_CONTACT)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_10x24_CONTACT:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_10x24_CONTACT)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_9x21_MAG:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_9x21_MAG)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_9x9_MAG:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_9x9_MAG)[PaddleConfig::PADDLE_COLLIMATION]);
		case paddleCodes::PADDLE_D75_MAG:return System::Convert::ToByte(PaddleConfig::Configuration->getParam(PaddleConfig::PARAM_PADDLE_D75_MAG)[PaddleConfig::PADDLE_COLLIMATION]);
		}
	}
	catch (...) {
		return 0;
