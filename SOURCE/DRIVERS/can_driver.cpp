...
canDriver::canDriver(void):masterInterface(SYSCONFIG->getParam<QString>(SYS_CAN_PROCESS_PARAM,SYS_CAN_IP),SYSCONFIG->getParam<int>(SYS_CAN_PROCESS_PARAM,SYS_CAN_SERVICE))
{
