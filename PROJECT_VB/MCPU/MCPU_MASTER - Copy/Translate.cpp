...
static const char* ENG_ARRAY[] = {
	#include "LANGUAGE/translate_eng.h"
	"LAST"
};

static const char* ITA_ARRAY[] = {
	#include "LANGUAGE/translate_ita.h"
	"LAST"
};

static const char* FRA_ARRAY[] = {
	#include "LANGUAGE/translate_fra.h"
	"LAST"
};

static const char* ESP_ARRAY[] = {
	#include "LANGUAGE/translate_esp.h"
	"LAST"
};

static const char* POR_ARRAY[] = {
	#include "LANGUAGE/translate_por.h"
	"LAST"
};

static const char* RUS_ARRAY[] = {
	#include "LANGUAGE/translate_rus.h"
	"LAST"
};
...
Translate::Translate(String^ language){
